...
@section('content')
        ...
        <script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/transaksi/status/proses';
                }
            });
        </script>
    @endif --}}
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Order Baru</h2>

        @if ($transactions->isEmpty())
            <div class="bg-white text-center text-gray-500 p-6 rounded shadow">
                Belum ada transaksi order baru.
            </div>
        @else
    ...
    <script>
        function confirmStatus(url, action) {
            Swal.fire({
                ...
                text: `Apakah kamu yakin ingin ${action.toLowerCase()} transaksi ini?`,
                icon: 'question',
