...
@section('content')
        ...
        <script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/transaksi/status/siap diambil';
                }
            });
        </script>
    @endif --}}
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Transaksi Proses</h2>
                        ...
                        @auth
                            @if (auth()->user()->role->nama === 'Admin')
                                <div class="flex justify-end">
                                    <button
                                        onclick="confirmStatus('{{ route('admin.transaksi.updateStatus', [$transaksi->id, 'siap diambil']) }}', 'Siap Diambil')"
